<template>
    <div class="col-12 col-md-9">
        <div class="border bg-white rounded border-warning pt-2 pb-2 mb-3" v-for="lists in lists">
            <div class="col-12 border-warning list-inline" style="border-left: 5px solid;">
                ...
                <div class="w-100 list-inline">
                    <button type="button" class="btn btn-success list-inline-item">Confirm</button>
    ...
    export default {
        ...
        methods: {
            loadlist: function (event) {
                axios.get('/api/garageregisters/admin/list/0').then((response)=>{
